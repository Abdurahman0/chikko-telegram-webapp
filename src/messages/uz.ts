...
export const uzMessages: Messages = {
  ...
  checkout: {
    ...
    fulfillmentMethod: "Yetkazish usuli",
  ...
  reviews: {
    ...
    productSectionTitle: "Mahsulot fikrlari",
    leaveReview: "Fikr qoldirish",
    noReviews: "Fikrlar yo'q",
    noProductReviews: "Ushbu mahsulot uchun fikrlar hali yo'q",
    ...
    disabled: "Bu mahsulotlar uchun fikr-mulohaza vaqtincha o'chirilgan.",
  },
};
