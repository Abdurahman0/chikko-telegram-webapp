...
export const ruMessages: Messages = {
  ...
  checkout: {
    ...
    fulfillmentMethod: "Способ получения",
    delivery: "Доставка",
    pickup: "Самовывоз",
  ...
  reviews: {
    ...
    productSectionTitle: "Отзывы о товаре",
    leaveReview: "Оставить отзыв",
    noReviews: "Отзывов нет",
    noProductReviews: "По этому товару пока нет отзывов",
    ...
    disabled: "Отзывы для этих товаров временно отключены.",
  },
};
